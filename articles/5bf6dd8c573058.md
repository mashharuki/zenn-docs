...
2011年から2012年にかけてビットコインの初期コントリビューターを含む3人の開発者によって開発されたレイヤー1ブロックチェーンなのです！
...
XRPLでトークンをスワップさせてみたいという場合には下記記事が参考になります！
...
XRPLとは直接関係ないのですが、今回フロントのソースコードは下記GitHubリポジトリをベースに開発しています。

https://github.com/Siumauricio/nextui-dashboard-template

Next.jsを使ってダッシュボード画面を作りたいという場合には参考になると思いますので共有いたします！！
