...
後は、 **MCP用のライブラリ**を使ってAIが呼び出しやすいように適切な入力スキーマと出力スキーマを定義し、MCPとして実装することが必要になってきます！
...
今後やってみたいこととしては**Cloud Run**で動かしてみたりとか**MCPに認証機能を追加**してみることなどですかね。

**OAuth2.1**という規格も出てきているみたいです！
